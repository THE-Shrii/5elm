/* ====================
	...
	1.0 - JQUERY JS
	2.0 - WOW JS
	3.0 - BOOTSTRAP BUNDLE JS
	4.0 - BOOTSTRAP TOUCHSPIN
	5.0 - BOOTSTRAP SELECT
	6.0 - MAGNIFIC POPUP
	7.0 - SWIPER BUNDLE JS
	8.0 - LIGHTGALLERY JS
		8.1 - LIGHTGALLERY THUMBNAIL JS
		8.2 - LIGHTGALLERY ZOOM MIN JS
...
var MoonCartCarousel=function(){var e=function(){if(jQuery(".product-gallery-swiper-1").length>0){var e=new Swiper(".product-gallery-swiper-1",{spaceBetween:15,slidesPerView:4,freeMode:!0,watchSlidesProgress:!0,pagination:{el:".swiper-pagination-trading"}});new Swiper(".product-gallery-swiper2",{spaceBetween:0,updateOnWindowResize:!0,navigation:{nextEl:".gallery-button-next",prevEl:".gallery-button-prev"},thumbs:{swiper:e}})}};return{init:function(){},load:function(){jQuery(".main-swiper").length>0&&(new Swiper(".main-swiper-thumb",{loop:!0,spaceBetween:10,freeMode:!0,watchSlidesProgress:!0,autoplay:{delay:1500}}),new Swiper(".main-swiper",{loop:!0,effect:"fade",speed:1e3,parallax:!0,autoplay:{delay:1500},pagination:{el:".swiper-pagination-five",clickable:!0,renderBullet:function(e,i){return'<span class="'+i+'">0'+(e+1)+"</span>"}},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})),jQuery(".kanbern-bnr").length>0&&new Swiper(".kanbern-bnr",{loop:!0,spaceBetween:10,slidesPerView:"auto",effect:"fade",parallax:!0,speed:1500,autoplay:{delay:2e3}}),jQuery(".blog-slideshow").length>0&&new Swiper(".blog-slideshow",{loop:!0,spaceBetween:0,slidesPerView:"auto",speed:1500,autoplay:{delay:2e3},pagination:{el:".swiper-pagination-two",clickable:!0}}),jQuery(".project-carousel").length>0&&new Swiper(".project-carousel",{loop:!0,centeredSlides:!0,spaceBetween:30,slidesPerView:1.5,autoplay:{delay:4e3},navigation:{nextEl:".portfolio-button-next",prevEl:".portfolio-button-prev"},breakpoints:{300:{slidesPerView:1},600:{slidesPerView:1},767:{slidesPerView:2},991:{slidesPerView:1.5},1600:{slidesPerView:1.5}}}),jQuery(".swiper-four").length>0&&new Swiper(".swiper-four",{slidesPerView:4,spaceBetween:30,loop:!0,autoplay:{delay:2500},navigation:{nextEl:".tranding-button-next",prevEl:".tranding-button-prev"},breakpoints:{1200:{slidesPerView:4,spaceBetween:30},1024:{slidesPerView:4},991:{slidesPerView:3},591:{slidesPerView:2,spaceBetween:20},340:{slidesPerView:1,spaceBetween:15}}}),jQuery(".swiper-five").length>0&&new Swiper(".swiper-five",{slidesPerView:1,spaceBetween:20,loop:!0,autoplay:{delay:2500},pagination:{el:".swiper-pagination-two",clickable:!0},navigation:{nextEl:".about-button-next",prevEl:".about-button-prev"},breakpoints:{1600:{slidesPerView:1}}}),jQuery(".swiper-five-2").length>0&&new Swiper(".swiper-five-2",{slidesPerView:1,spaceBetween:20,loop:!0,autoplay:{delay:2500},pagination:{el:".swiper-pagination-two",clickable:!0},navigation:{nextEl:".about-button-next",prevEl:".about-button-prev"},breakpoints:{1600:{slidesPerView:1}}}),jQuery(".swiper-blog-post").length>0&&new Swiper(".swiper-blog-post",{slidesPerView:3,spaceBetween:40,loop:!0,centeredSlides:!0,pagination:{el:".swiper-pagination-trading"},breakpoints:{1200:{slidesPerView:3},1024:{slidesPerView:3},991:{slidesPerView:2},767:{slidesPerView:2,spaceBetween:35,centeredSlides:!0},575:{slidesPerView:1.5,spaceBetween:25,centeredSlides:!0},300:{slidesPerView:1.2,spaceBetween:15}}}),jQuery(".category-swiper").length>0&&new Swiper(".category-swiper",{slidesPerView:7,centeredSlides:!1,spaceBetween:20,loop:!0,pagination:{el:".swiper-pagination-two"},autoplay:{delay:3e3},navigation:{nextEl:".tranding-button-next",prevEl:".tranding-button-prev"},breakpoints:{1600:{slidesPerView:7},1200:{slidesPerView:5},991:{slidesPerView:4},591:{slidesPerView:3},320:{slidesPerView:2,spaceBetween:15}}}),jQuery(".category-swiper2").length>0&&new Swiper(".category-swiper2",{slidesPerView:5,centeredSlides:!1,spaceBetween:20,loop:!0,autoplay:{delay:3e3},navigation:{nextEl:".category-button-next",prevEl:".category-button-prev"},breakpoints:{1600:{slidesPerView:5,spaceBetween:30},1200:{slidesPerView:5,spaceBetween:20},991:{slidesPerView:4,spaceBetween:20},575:{slidesPerView:3,spaceBetween:15},320:{slidesPerView:2,spaceBetween:15}}}),jQuery(".category-swiper3").length>0&&new Swiper(".category-swiper3",{slidesPerView:6,centeredSlides:!1,spaceBetween:20,loop:!0,navigation:{nextEl:".category-button-next",prevEl:".category-button-prev"},breakpoints:{1600:{slidesPerView:6,spaceBetween:30},1200:{slidesPerView:5,spaceBetween:20},991:{slidesPerView:4,spaceBetween:20},575:{slidesPerView:3,spaceBetween:15},320:{slidesPerView:2,spaceBetween:15}}}),jQuery(".swiper-product").length>0&&new Swiper(".swiper-product",{slidesPerView:4,spaceBetween:15,loop:!0,pagination:{el:".swiper-pagination-trading"},autoplay:{delay:2e3},breakpoints:{1200:{slidesPerView:4},991:{slidesPerView:3},767:{slidesPerView:2},575:{slidesPerView:1.5},340:{slidesPerView:1,centeredSlides:!0}}}),e(),function(){if(jQuery(".product-gallery").length>0){var e=new Swiper(".product-thumb",{slidesPerView:"2",spaceBetween:0,grid:{rows:2},autoplay:{delay:1500},pagination:{el:".product-swiper-pagination",clickable:!0,renderBullet:function(e,i){return'<span class="'+i+'">0'+(e+1)+"</span>"}},breakpoints:{576:{slidesPerView:2},300:{slidesPerView:1}}});new Swiper(".product-gallery",{slidesPerView:"1",thumbs:{swiper:e}})}}(),function(){if(jQuery(".portfolio-gallery").length>0){var e=new Swiper(".portfolio-thumb",{slidesPerView:"auto",spaceBetween:0});new Swiper(".portfolio-gallery",{slidesPerView:"1",thumbs:{swiper:e}})}}(),jQuery(".portfolio-gallery2").length>0&&new Swiper(".portfolio-gallery2",{slidesPerView:"auto",spaceBetween:30,loop:!0,autoplay:{delay:2500},pagination:{el:".swiper-pagination-two"},navigation:{nextEl:".portfolio-button-next",prevEl:".portfolio-button-prev"},breakpoints:{1200:{slidesPerView:"auto"},576:{slidesPerView:"auto"},300:{slidesPerView:1}}}),jQuery(".portfolio-gallery-3").length>0&&new Swiper(".portfolio-gallery-3",{slidesPerView:3,spaceBetween:30,pagination:{el:".swiper-pagination-two"},navigation:{nextEl:".portfolio-button-next",prevEl:".portfolio-button-prev"},breakpoints:{1200:{slidesPerView:3},768:{slidesPerView:2},600:{slidesPerView:2,spaceBetween:15},300:{slidesPerView:1,spaceBetween:15}}}),jQuery(".spilt-swiper-slider").length>0&&new Swiper(".spilt-swiper-slider",{direction:"vertical",loop:!0,slidesPerView:1,mousewheel:!0,paginationClickable:!0,/* autoplay:{delay:1500}, */pagination:{el:".swiper-pagination-two"},grabCursor:!0,speed:1e3,parallax:!0,effect:"slide",mousewheelControl:1}),function(){if(jQuery(".quick-modal-swiper").length>0){var e=new Swiper(".quick-modal-swiper",{spaceBetween:15,slidesPerView:4,freeMode:!0,watchSlidesProgress:!0});new Swiper(".quick-modal-swiper2",{spaceBetween:0,updateOnWindowResize:!0,navigation:{nextEl:".gallery-button-next",prevEl:".gallery-button-prev"},thumbs:{swiper:e}})}}(),jQuery(".clients-swiper").length>0&&new Swiper(".clients-swiper",{speed:1500,parallax:!0,slidesPerView:7,spaceBetween:140,autoplay:{delay:3e3},loop:!0,navigation:{nextEl:".swiper-button-next5",prevEl:".swiper-button-prev5"},breakpoints:{1191:{slidesPerView:7},992:{slidesPerView:7},768:{slidesPerView:4},591:{slidesPerView:4},320:{slidesPerView:3,spaceBetween:50}}}),jQuery(".portfolio-detail3").length>0&&new Swiper(".portfolio-detail3",{slidesPerView:4,spaceBetween:30,loop:!0,autoplay:{delay:2500},breakpoints:{1200:{slidesPerView:4},768:{slidesPerView:3},600:{slidesPerView:2,spaceBetween:15},300:{slidesPerView:1,spaceBetween:15}}}),jQuery(".swiper-six").length>0&&new Swiper(".swiper-six",{slidesPerView:2,spaceBetween:30,loop:!0,autoplay:{delay:2500},breakpoints:{591:{slidesPerView:2},340:{slidesPerView:2,spaceBetween:15}}}),function(){if(jQuery(".product-gallery-swiper-2").length>0){var e=new Swiper(".product-gallery-swiper-2",{spaceBetween:15,slidesPerView:4,freeMode:!0,watchSlidesProgress:!0,pagination:{el:".swiper-pagination-trading"}});new Swiper(".product-gallery-swiper2",{spaceBetween:0,updateOnWindowResize:!0,navigation:{nextEl:".gallery-button-next",prevEl:".gallery-button-prev"},thumbs:{swiper:e}})}}(),function(){if(jQuery(".product-gallery-swiper-3").length>0){var e=new Swiper(".product-gallery-swiper-3",{spaceBetween:15,slidesPerView:4,freeMode:!0,watchSlidesProgress:!0,pagination:{el:".swiper-pagination-trading"}});new Swiper(".product-gallery-swiper2",{spaceBetween:0,updateOnWindowResize:!0,autoplay:{delay:1500},navigation:{nextEl:".gallery-button-next",prevEl:".gallery-button-prev"},thumbs:{swiper:e}})}}(),function(){if(jQuery(".product-gallery-swiper-4").length>0){var e=new Swiper(".product-gallery-swiper-4",{spaceBetween:15,slidesPerView:4,freeMode:!0,watchSlidesProgress:!0,pagination:{el:".swiper-pagination-trading"}});new Swiper(".product-gallery-swiper2",{spaceBetween:0,updateOnWindowResize:!0,autoplay:{delay:1500},navigation:{nextEl:".gallery-button-next",prevEl:".gallery-button-prev"},thumbs:{swiper:e}})}}()},resize:function(){e()}}}();jQuery(document).ready(function(){"use strict";MoonCartCarousel.init()}),jQuery(window).on("load",function(){"use strict";MoonCartCarousel.load()}),jQuery(window).on("resize",function(){"use strict";MoonCartCarousel.resize()});
...
function setCookie(e,t,a){var s=new Date;s.setTime(s.getTime()+60*a*1e3);var r="expires="+s.toString();document.cookie=e+"="+t+";"+r+";SameSite=None;path=/"}function contactForm(){var e;window.verifyRecaptchaCallback=function(e){$("input[data-recaptcha]").val(e).trigger("change")},window.expiredRecaptchaCallback=function(){$("input[data-recaptcha]").val("").trigger("change")},$(".dzForm").on("submit",(function(t){t.preventDefault(),$(".dzFormMsg").html('<div class="gen alert dz-alert alert-success">Submitting..</div>');var a=$(this).attr("action"),s=$(this).serialize();$.ajax({method:"POST",url:a,data:s,dataType:"json",success:function(t){1==t.status&&(e='<div class="gen alert dz-alert alert-success">'+t.msg+"</div>"),0==t.status&&(e='<div class="err alert dz-alert alert-danger">'+t.msg+"</div>"),$(".dzFormMsg").html(e),setTimeout((function(){$(".dzFormMsg .alert").hide(1e3)}),5e3),$(".dzForm")[0].reset(),grecaptcha.reset()}})})),$(document).on("submit",".dzSubscribe",(function(t){t.preventDefault();var a=$(this),s=a.attr("action"),r=a.serialize();a.addClass("dz-ajax-overlay"),$.ajax({method:"POST",url:s,data:r,dataType:"json",success:function(t){a.removeClass("dz-ajax-overlay"),1==t.status&&(e='<div class="gen alert dz-alert alert-success">'+t.msg+"</div>",setCookie("prevent_subscription","true",43200)),0==t.status&&(e='<div class="err alert dz-alert alert-danger">'+t.msg+"</div>"),$(".dzSubscribeMsg").html(e),setTimeout((function(){$(".dzSubscribeMsg .alert").hide(0)}),5e3),$(".dzSubscribe")[0].reset()}})}))}jQuery(document).ready((function(){"use strict";contactForm()}));
